    ...
    <div className="homepage">
      ...
      <section className="banner">
        <div className="banner-text">
          <h2>Shop Fresh, <span className="heading2">Organic</span> Products</h2>
          <p>
            Everything you need for a healthy lifestyle, delivered to your door. $5 delivery fee for orders above 20 pounds!
          </p>
      ...
      <section className="category" id="category">
        ...
        <Swiper
          modules={[Pagination, Navigation]} // Updated to include modules directly
          slidesPerView={1}
          spaceBetween={15}
          navigation
        ...
        >
          ...
          <SwiperSlide>
            <a className="box dairy-alternatives" href="/search?category=dairy%2520alternatives">
          ...
          <SwiperSlide>
            <a className="box frozen-desserts" href="/search?category=frozen%2520desserts">
              <h3>Frozen Desserts</h3>
              <img src="icecream.jpg" alt="Frozen Desserts" />
            </a>
          </SwiperSlide>
          <SwiperSlide>
            <a className="box frozen-foods" href="/search?category=frozen%2520foods">
              <h3>Frozen Foods</h3>
              <img src="amypizza.jpg" alt="Frozen Foods" />
            </a>
          </SwiperSlide>
          <SwiperSlide>
            <a className="box canned-goods" href="/search?category=canned%2520goods">
              <h3>Canned Goods</h3>
